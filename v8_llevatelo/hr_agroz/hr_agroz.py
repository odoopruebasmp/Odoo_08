...
class hr_capacitaciones(osv.Model):
    ...
    _columns = {
        'type': fields2.selection([('bachiller', 'Bachiller'), ('profesional', 'Profesional'), ('posgrado', 'Posgrado'), ('curso', 'Curso'), ('diplomado', 'Diplomado'), ('tecnologia', 'Tecnologia'), ('tecnico', 'Tecnico')], "Tipo de programa"),
