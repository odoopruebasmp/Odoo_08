    ...
    def check_overlap(self, cr, uid, ids, context=None):
        for holiday in self.browse(cr, uid, ids, context=context):
            ...
            if overlap and not holiday.holiday_status_id.overlap and not commodity:
                raise Warning(u"No se puede confirmar una ausencia del empleado {e} que se sobrelape o cruce en fechas "
                              u"con otra del mismo empleado".format(e=holiday.contract_id.employee_id.name))
...
class hr_holidays_status(osv.osv):
    ...
    _columns = {
        ...
        'gi_full_ibc': fields.boolean('Reconocer el 100% del IBC para las incapacidades en PILA'),
