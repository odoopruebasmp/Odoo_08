...
class purchase_requisition_line(models.Model):
    ...
    location_id = fields.Many2one('stock.location', string='Lugar de Entrega', required=True, readonly=False, states={'draft':[('readonly',False)]}, domain=[('usage', '=', 'internal'),('purchase_ok', '=', True)])
